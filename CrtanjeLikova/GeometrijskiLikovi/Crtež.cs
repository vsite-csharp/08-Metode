...
namespace Vsite.CSharp.Metode.GeometrijskiLikovi
{
    ...
    class Crtež
    {
        ...
        private void SložiOgledniCrtež()
        {
            ...
            DodajLik(new Pravokutnik(80, 120, 150, 40, Brushes.Red, Pens.Black));
            DodajLik(new Pravokutnik(150, 100, 50, 150, Brushes.Red, Pens.Black));
            ...
            DodajLik(new Elipsa(180, 80, 50, 80, Brushes.Red, Pens.Black));
