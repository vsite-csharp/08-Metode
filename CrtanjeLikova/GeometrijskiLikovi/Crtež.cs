...
namespace Vsite.CSharp.Metode.GeometrijskiLikovi
{
    ...
    class Crtež
    {
        ...
        {
            DodajLik(new Pravokutnik(10, 10, 40, 30, Color.Aquamarine, Color.DeepPink));
            DodajLik(new Pravokutnik(80, 120, 150, 40, Color.Azure, Color.DarkSlateGray));
            DodajLik(new Pravokutnik(150, 100, 50, 150, Color.Blue, Color.HotPink));
            ...
            DodajLik(new Elipsa(80, 60, 60, 40, Color.DarkKhaki, Color.Lavender));
            DodajLik(new Elipsa(180, 80, 50, 80, Color.DarkOrange, Color.Olive));
