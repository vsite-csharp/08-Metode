...
namespace Vsite.CSharp.Metode.GeometrijskiLikovi
{
    ...
    class Crtež
    {
        ...
        {
            DodajLik(new Pravokutnik(10, 10, 40, 30,Pens.Bisque,Brushes.Crimson));
            DodajLik(new Pravokutnik(80, 120, 150, 40, Pens.AntiqueWhite, Brushes.DodgerBlue));
            DodajLik(new Pravokutnik(150, 100, 50, 150, Pens.HotPink, Brushes.Orange));
            ...
            DodajLik(new Elipsa(80, 60, 60, 40, Pens.MediumOrchid, Brushes.LightBlue));
            DodajLik(new Elipsa(180, 80, 50, 80, Pens.PaleGoldenrod, Brushes.AntiqueWhite));
