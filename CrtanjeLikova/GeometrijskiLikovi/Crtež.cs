...
namespace Vsite.CSharp.Metode.GeometrijskiLikovi
{
    ...
    class Crtež
    {
        ...
        {
            DodajLik(new Pravokutnik(10, 10, 40, 30, Color.Red, Pens.Green));
            DodajLik(new Pravokutnik(80, 120, 150, 40, Color.Red, Pens.Green));
            DodajLik(new Pravokutnik(150, 100, 50, 150, Color.Red, Pens.Green));
            ...
            DodajLik(new Elipsa(80, 60, 60, 40, Color.Purple, Pens.Yellow));
            DodajLik(new Elipsa(180, 80, 50, 80, Color.Purple, Pens.Yellow));
