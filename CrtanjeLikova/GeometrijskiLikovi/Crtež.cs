...
{
    // DID_IT:090 Pokrenuti program i provjeriti funkcioniranje tipki na alatnoj traci (toolbar).
    class Crtež
    {
        public Crtež()
        {
        ...
        private void SložiOgledniCrtež()
        {
            ...
            // DID_IT:091 U projekt dodati novu klasu Elipsa, izvedenu iz klase GeometrijskiLik te implemenirati potrebne metode.

            // DID_IT:092 Otkomentirati donje naredbe i pokrenuti program.
