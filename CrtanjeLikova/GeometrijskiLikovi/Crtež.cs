...
namespace Vsite.CSharp.Metode.GeometrijskiLikovi
{
    ...
    class Crtež
    {
        ...
        {
            DodajLik(new Pravokutnik(10, 10, 40, 30, Pens.Blue, Brushes.Red));
            DodajLik(new Pravokutnik(80, 120, 150, 40, Pens.Blue , Brushes.Red));
            DodajLik(new Pravokutnik(150, 100, 50, 150, Pens.Blue, Brushes.Red));
            ...
            DodajLik(new Elipsa(80, 60, 60, 40, Pens.Green, Brushes.Red));
            DodajLik(new Elipsa(180, 80, 50, 80, Pens.Green, Brushes.Red));
