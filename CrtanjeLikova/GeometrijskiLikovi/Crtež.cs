...
namespace Vsite.CSharp.Metode.GeometrijskiLikovi
{
    ...
    class Crtež
    {
        ...
        {
            DodajLik(new Pravokutnik(10, 10, 40, 30, Color.OrangeRed, Color.DarkBlue));
            DodajLik(new Pravokutnik(80, 120, 150, 40, Color.DarkGreen, Color.DarkOrange));
            DodajLik(new Pravokutnik(150, 100, 50, 150, Color.BlueViolet, Color.Chartreuse));
            ...
            DodajLik(new Elipsa(80, 60, 60, 40, Color.Black, Color.Aqua));
            DodajLik(new Elipsa(180, 80, 50, 80, Color.MediumVioletRed, Color.OrangeRed));
