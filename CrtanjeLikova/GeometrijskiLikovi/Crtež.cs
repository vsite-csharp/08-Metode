...
namespace Vsite.CSharp.Metode.GeometrijskiLikovi
{
    ...
    class Crtež
    {
        ...
        {
            DodajLik(new Pravokutnik(10, 10, 40, 30, Color.BlueViolet, Color.DarkRed));
            DodajLik(new Pravokutnik(80, 120, 150, 40, Color.DarkRed, Color.BlueViolet));
            DodajLik(new Pravokutnik(150, 100, 50, 150, Color.Black, Color.Black));
            ...
            DodajLik(new Elipsa(80, 60, 60, 40, Color.Black, Color.ForestGreen));
            DodajLik(new Elipsa(180, 80, 50, 80, Color.Black, Color.Salmon));
