...
namespace Vsite.CSharp.Metode
{
    ...
    {
        public new void IspišiImeObično() // zeleno podcrtano sakriva onu iz bazne klase...kao jesmo li sigurni da to želimo pa dodajemo ->new
        {
    ...
    class Izvedena2 : Bazna
    {
        ...
        public override void IspišiImeVirtualno() //overridamo izvedene funkcije
        {
