...
namespace Vsite.CSharp.Metode
{
    ...
    // DID_IT:082 U klase Izvedena1 i Izvedena2 dodajte javno dostupne metode IspišiImeObično koje će ispisati "Izvedena1 Obično", odnosno "Izvedena2 Obično". Pokrenite program i usporedite ispise s prijašnjima.
    // DID_IT:083 U klase Izvedena1 i Izvedena2 dodajte javno dostupne metode IspišiImeVirtualno koje će ispisati "Izvedena1 Virtualno", odnosno "Izvedena2 Virtualno". Pokrenite program i usporedite ispise s prijašnjima.
    ...
    static class VirtualneMetode
    {
        ...
        static void Main()
        {
            // DID_IT:080 Pogledajte metode PoziviNevirtualnihMetoda i PoziviVirtualnihMetoda i zaključite što će se ispisati prilikom njihova poziva.
            // DID_IT:081 Pokrenite program i provjerite što će se ispisati.
