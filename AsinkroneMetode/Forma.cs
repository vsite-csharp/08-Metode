namespace Vsite.CSharp.Metode
{
    public partial class Forma : Form
    {
        ...
        // Pogledati što se izvršava na pritisak treće tipke. Pokrenuti program i provjeriti njegov odziv.
        private async void buttonAsinkroni2_ClickAsync(object sender, EventArgs e)
        {
            ...
            // Staviti točke prekida (breakpoints) na zadnje četiri naredbe u ovoj metodi (uključujući i praznu naredbu) i naredbu iza TODO:135a.
        ...
        async Task<string> NekaTrećaOperacijaKojaVRaćaRezultat()
        {
            ...
            for (int i = 1; i < BrojPonavljanja; ++i)
            {
                // Staviti točku prekida na donju naredbu.
                progressBar.Value = i;
                await Task.Delay(Interval);
            }
            progressBar.Value = 0;
