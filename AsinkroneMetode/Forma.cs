...
namespace Vsite.CSharp.Metode
{
    public partial class Forma : Form
    {
        ...
        private async void buttonAsinkroni2_ClickAsync(object sender, EventArgs e)
        {
            ...
            // :133 Otkomentirati donju naredbu, pokrenuti program te pritisnuti treću tipku.
            await NekaDrugaDugotrajnaOperacija();

            // :134 Staviti točke prekida (breakpoints) na zadnje četiri naredbe (uključujući i praznu naredbu) i naredbu iza TODO:134a.
            // :135 Pokrenuti program i pogledati redoslijed izvođenja naredbi.
