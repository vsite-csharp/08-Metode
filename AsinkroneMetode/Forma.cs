...
namespace Vsite.CSharp.Metode
{
    public partial class Forma : Form
    {
        ...
        private async void buttonAsinkroni2_ClickAsync(object sender, EventArgs e)
        {
            ...
            // TODO:133 Otkomentirati donju naredbu, pokrenuti program te pritisnuti treću tipku.
            //await NekaDrugaDugotrajnaOperacija();

            // TODO:134 Staviti točke prekida (breakpoints) na zadnje četiri naredbe (uključujući i praznu naredbu) i naredbu iza TODO:134a.
            // TODO:135 Pokrenuti program i pogledati redoslijed izvođenja naredbi.
        ...
        async Task<string> NekaTrećaOperacijaKojaVRaćaRezultat()
        {
            ...
            for (int i = 1; i < BrojPonavljanja; ++i)
            {
                // TODO:134a Staviti točku prekida na donju naredbu.
                progressBar.Value = i;
                await Task.Delay(Interval);
            }
            progressBar.Value = 0;
