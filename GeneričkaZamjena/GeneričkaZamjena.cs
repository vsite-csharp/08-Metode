...
namespace Vsite.CSharp.Metode
{
    class GeneričkaZamjena
    {
        ...
        public static void Zamijeni<T>(ref T prvi, ref T drugi) // koncencijom <T> kao Type
        {
            T priv = prvi; // priv - privremeni
            prvi = drugi;
            drugi = priv;
        }
        ...
        static void Main(string[] args)
        {
            ...
            Zamijeni<int>(ref i1, ref i2); // kompajler sam zakljuluje koji je tip, <int> je suvišan
