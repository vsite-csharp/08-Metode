...
namespace Vsite.CSharp.Metode
{
    class Preopterećenje
    {
        ...
        // 001 Napisati statičku javno dostupnu preopterećenu verziju metode MojaMetoda koja prima dva argumenta: prvi tipa int,
        // a drugi tipa double. Metoda mora ispisati $"MojaMetoda(int {broj1}, double {broj2})"
        ...
        static void Main(string[] args)
        {
            ...
            MojaMetoda(i1, i2); //zove se druga metoda, jer se trazi sto manje implicintnih pretvorbi!
            MojaMetoda(i1, d1);
            MojaMetoda(d1, d2);//prva
            MojaMetoda(d1, i2);//prva jer double ne moze u int!
