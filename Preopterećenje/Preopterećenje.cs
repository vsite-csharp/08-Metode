...
namespace Vsite.CSharp.Metode
{
    class Preopterećenje
    {
        ...
        {
            //Preopterećenje je kada jednoj metodi s jednim imenom, damo različit broj varijabli 
            //
        ...
        static void Main(string[] args)
        {
            ...
            //Ako ne postoji potpuno slaganje, traži se metoda koja zahtjeva najmanje implicitno pretvaranje
            MojaMetoda(i1, i2);
            MojaMetoda(i1, d1);
            MojaMetoda(d1, d2);
            MojaMetoda(d1, i2);
