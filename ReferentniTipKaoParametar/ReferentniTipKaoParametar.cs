...
namespace Vsite.CSharp.Metode
{
    ...
    class ReferentniTipKaoParametar
    {
        ...
        public static void PromjenaArgumentaReferentnogTipa()
        {
            ...
            // Dodati poziv metode ZamijeniOsobuMirkom s prosljeđenom osobom janko i ispisati osobu nakon poziva te metode.
            ...
            // Pokrenuti i provjeriti testove (test ReferentiTipKaoArgument_NakonIzlaskaIzMetodeObjektJeNepromijenjen treba proći)
        }
